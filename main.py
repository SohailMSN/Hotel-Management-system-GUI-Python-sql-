...
#chilanka
Label(sroot,text="Hotel Management System ",font='Timesnewroman 28 ',bg='white',fg='black').place(x=535,y=10)
Label(sroot,text="Made by -",font='Timesnewroman 30 ',bg='white',fg='black').place(x=535,y=90)
Label(sroot,text="Sohail And Suresh",font='Timesnewroman 35 ',bg='white',fg='grey').place(x=535,y=180)
...
def mainroot():
	...
	root.title("Made by Suresh And Sohail")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	path = r"C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/newestbg5.jpg"
	...
	def hotel_status():
		...
		path = r"C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/newbg6lf.jpg"
		img = ImageTk.PhotoImage(Image.open(path))
	...
	def staff():
		...
		'''
		emp1f = Frame(b_frame)
		path1 = r"C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/newman.jpg"
		...
		Label(emp1inf,text="Mr. Sohail",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		emp1f = Frame(b_frame)
		path2 = r"C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/receptionnew.jpg"
		...
		Label(emp1inf,text="Ms. Ayesha",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		emp1f = Frame(b_frame)
		path3 = r"C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/fchefnew.jpg"
		...
		Label(emp1inf,text="Mr. Suresh (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		emp1f = Frame(b_frame)
		path4 = r"C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/roomservicenew.jpg"
		...
		Label(emp1inf,text="Ms. Mahnoor (Head)",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
	...
	path = r"C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/rooms.png"
	img = ImageTk.PhotoImage(Image.open(path))
	b1 = Button(sl_frame,image=img,text='b1',bg='white',width=180,command=rooms)
	b1.image = img
	b1.place(x=180,y=0)
	path2 = r"C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/hotelstatus.png"
	img1 = ImageTk.PhotoImage(Image.open(path2))
	b2 = Button(sl_frame,image=img1,text='b2',bg='white',width=180,command=hotel_status)
	b2.image = img1
	b2.place(x=0,y=0)
	path3=r'C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/guests.png'
	img3 = ImageTk.PhotoImage(Image.open(path3))
	b3 = Button(sl_frame,image=img3,text='b2',bg='white',width=180,command=staff)
	b3.image = img3
	b3.place(x=180*4,y=0)
	path4=r'C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/payments.png'
	img4 = ImageTk.PhotoImage(Image.open(path4))
	b4 = Button(sl_frame,image=img4,text='b2',bg='white',width=180,command = payments)
	b4.image = img4
	b4.place(x=180*3,y=0)
	path5=r'C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/logout.png'
	...
	path6=r'C:\Users\pc\Desktop\hotel-management-system-master (4)\hotel-management-system-master\images/Bookroom.png'
